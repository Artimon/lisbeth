...
require_once $basePath . '/lisbeth/icollection.php';
require_once $basePath . '/lisbeth/collection.php';
require_once $basePath . '/lisbeth/ientity.php';
require_once $basePath . '/lisbeth/entity.php';
require_once $basePath . '/lisbeth/memcache.php';
require_once $basePath . '/lisbeth/objectpool.php';